...
def _to_utc_datetime(dt_input, tz_input):
    ...
    if tz_input.mode == "iana":
        ...
        if offsets_differ:
            ...
            if round_trip.replace(tzinfo=None) != naive:
                ...
                alt_offset_hours = alt_local_dt.utcoffset().total_seconds() / 3600.0
                dst_warning = (
...
def compute_time_conversion(dt_input, tz_input, location, trace: Trace) -> dict:
    utc_dt, offset_hours, tz_label, dst_warning = _to_utc_datetime(dt_input, tz_input)
