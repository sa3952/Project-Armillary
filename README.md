...
python scripts/verify_privacy_dependencies.py --check
python scripts/verify_ephemeris_integrity.py --manifest deploy/ephemeris.sha256 --ephemeris-dir backend/ephe
```
